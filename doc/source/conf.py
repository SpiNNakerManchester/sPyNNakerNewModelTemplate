...
project = 'sPyNNaker New Model Template'
...
htmlhelp_basename = 'sPyNNakerNewModelTemplatedoc'
...
latex_documents = [
  ('index', 'sPyNNakerNewModelTemplate.tex',
   'sPyNNakerNewModelTemplate Documentation', '', 'manual'),
]
...
man_pages = [
    ('index', project,
     'sPyNNaker New Model Template Documentation',
     [''], 1)
]
...
texinfo_documents = [
  ('index', project,
   'sPyNNaker New Model Template Documentation', '', project, '',
   'Miscellaneous'),
]
