...
class MyModelCurrMySynapseTypeDataHolder(DataHolder):
    def __init__(
            ...
            label=AbstractPopulationVertex.none_pynn_default_parameters[
                'label'],
            v_init=MyModelCurrMySynapseTypeBase.none_pynn_default_parameters['v_init'],
            v_thresh=MyModelCurrMySynapseTypeBase.default_parameters['v_thresh'],
            my_ex_synapse_parameter=MyModelCurrMySynapseTypeBase.default_parameters[
                'my_ex_synapse_parameter'],
            my_in_synapse_parameter=MyModelCurrMySynapseTypeBase.default_parameters[
            ...
            my_inh_init=MyModelCurrMySynapseTypeBase.default_parameters[
                'my_inh_init'],
            my_parameter=MyModelCurrMySynapseTypeBase.default_parameters['my_parameter'],
            i_offset=MyModelCurrMySynapseTypeBase.default_parameters['i_offset']):
        DataHolder.__init__(
            self, {
