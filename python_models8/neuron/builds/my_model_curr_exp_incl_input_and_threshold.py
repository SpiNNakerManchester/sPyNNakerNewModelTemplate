...
# TODO: input types (all imported for help, only use one) don't use one here!
...
# threshold types (all imported for help, only use one) : don't need one here
# standard
...
class MyModelCurrExpInclInputAndThresholdBase(AbstractPopulationVertex):
    ...
    default_parameters = {
        'threshold_value': -50.0, 'tau_syn_E': 5.0, 'tau_syn_I': 5.0,
        'isyn_exc': 0.0, 'isyn_inh': 0.0,
        'i_offset': 0, 'my_neuron_parameter': -70.0,
        'my_threshold_parameter': 0.5, 'my_multiplicator': 0.0,
    ...
    def __init__(
            ...
            my_neuron_parameter=default_parameters['my_neuron_parameter'],
            i_offset=default_parameters['i_offset'],
            threshold_value=default_parameters['threshold_value'],
            my_threshold_parameter=default_parameters[
        ...
        neuron_model = MyNeuronModelInclInputAndThreshold(
            n_neurons, i_offset, my_neuron_parameter, my_multiplicator,
            my_input_parameter, threshold_value, my_threshold_parameter)
        ...
        AbstractPopulationVertex.__init__(
            ...
            model_name="MyModelCurrExpInclInputAndThresholdBase",

            # TODO: Set this to the matching binary name
            binary="my_model_curr_exp_incl_input_and_threshold.aplx")
    ...
    def my_neuron_parameter(self):
        return self.default_parameters['my_neuron_parameter']
