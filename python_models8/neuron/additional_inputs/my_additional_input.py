...
MY_PARAMETER = "my_additional_input_parameter"
...
class MyAdditionalInput(AbstractAdditionalInput):
    ...
    def add_parameters(self, parameters):
        ...
        parameters[MY_PARAMETER] = self._my_additional_input_parameter
    ...
    def get_values(self, parameters, state_variables, vertex_slice):
        ...
        return [parameters[MY_PARAMETER], state_variables[INPUT_CURRENT]]
