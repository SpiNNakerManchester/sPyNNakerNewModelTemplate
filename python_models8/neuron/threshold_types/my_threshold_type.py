...
class MyThresholdType(AbstractThresholdType):
    ...
    def add_parameters(self, parameters):
        ...
        parameters[THRESHOLD_TIME] = self._tau_th
        parameters[THRESHOLD_PARAM] = self._theta
    ...
    def get_values(self, parameters, state_variables, vertex_slice, ts):
        ...
        return [parameters[THRESHOLD_VALUE],
                parameters[THRESHOLD_TIME].apply_operation(lambda x: numpy.exp(-1/x)),
    ...
    def update_values(self, values, parameters, state_variables):
        ...
        (_threshold_value, _threshold_time, _threshold_param) = values
